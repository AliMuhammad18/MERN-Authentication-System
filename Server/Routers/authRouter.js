...
import {signup , continueWithGoogle , login , logout , refreshAccessToken , sendPasswordResetOtp , verifyPasswordResetOtp , resetPassword} from "../Controllers/auth/sfaController.js";
...
//SFA routes
authRouter.post("/signup" ,  rateLimiting(10, 60 * 10) , passwordValidator , emailValidator , nameValidator , signup);
